						...
						<TETabsPane
								...
								<div className="xl:w-[18%] w-[23%] my-auto flex flex-col justify-center items-center">
									<img
										...
										className={` w-32 object-cover object-center ${
											profilePic == userAvatart ? "h-32" : "h-[140px] shadow-lg"
										}  rounded-xl `}
									/>
									<button
									...
									<div>
										<div className="flex">
											<input
												...
												value={userName}
												className={`xl:text-[28px] text-[25px] font-semibold focus-visible:outline-none   ${
									...
									<div className="w-[80%] flex justify-between">
										<div>
											<P
												...
												className={`text-[#8C8E97] mb-2 xl:text-[20px] text-[18px] text-nowrap ${
													isEditMode && "pt-2"
												}`}>
												Phone Number
											</P>
										...
										<div>
											<input
												...
												value={userphone}
												className={`xl:text-[20px] w-fit ml-4 text-[18px] mb-2 focus-visible:outline-none ${
											...
											<input
												...
												value={userEmail}
												className={`xl:text-[20px] w-max ml-4 text-[18px] mb-2 focus-visible:outline-none ${
													isEditMode && "border-2 rounded-lg px-2 py-0.5"
												}`}></input>
										</div>
									</div>
							...
							<div className=" bg-white shadow-xl rounded-xl p-6 mb-8">
								...
								<textarea
									...
									value={aboutYourSelf}
									className={`xl:text-[20px]  ml-4 text-[18px] mb-2 focus-visible:outline-none w-full min-h-32 max-h-50 ${
