        ...
        <TEDropdownMenu>
          ...
          <TEDropdownItem>
            <button
              ...
              className="px-4  block text-black w-full min-w-[160px] cursor-pointer whitespace-nowrap bg-transparent py-2 text-sm text-left font-normal pointer-events-auto  hover:bg-neutral-100 active:text-neutral-800 active:bg-neutral-100 focus:bg-neutral-100 focus:text-neutral-800 focus:outline-none active:no-underline dark:text-neutral-500 dark:hover:bg-neutral-200 dark:focus:bg-neutral-600 dark:active:bg-neutral-600"
            >
              Logout
            </button>
          </TEDropdownItem>
